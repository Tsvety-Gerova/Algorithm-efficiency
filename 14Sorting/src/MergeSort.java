...
// Merge sort the second half
			...
			E[] secondHalf = (E[]) new Object[secondHalfLength]; // не може да се създават обекти от интерфейс 
...
// Merge firstHalf with secondHalf into list
	...
	public static <E> void merge(E[] list1, E[] list2, E[] temp, Comparator<E> comparator) {
		...
		while (current1 < list1.length && current2 < list2.length) {
			if (comparator.compare(list2[current2], list1[current1]) < 0) 
	...
	public static void main(String[] args) {
		Circle[] list = { new Circle(2) ,new Circle(3), new Circle(2), new Circle(5), new Circle(6), 
				new Circle(1), new Circle(12), new Circle(3), new Circle(14), new Circle(12) };
...
//// Merge sort the second half
//			int secondHalfLength = list.length - list.length / 2;
//			E[] secondHalf = (E[]) new Comparable[secondHalfLength]; // не може да се създават обекти от интерфейс 
//			System.arraycopy(list, list.length / 2, secondHalf, 0, secondHalfLength);
